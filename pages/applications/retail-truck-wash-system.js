          ...
          <div className={styles.headInfo}>
            ...
            <div className={styles.contentWrapper}>
              ...
              <div className={styles.content__text}>
                The InterClean commercial truck wash systems are the most
                advanced wash systems in the world. Fully automated commercial
                truck wash systems designed by InterClean can produce 15 to 30
                clean trucks per hour with only one employee. <br />
                <br />
                ...
                <br />
                InterClean does not design and build wash systems that use
                deadly hydrofluoric acid in any part of cleaning. InterClean
                opposes the use of hydrofluoric acid in any form in vehicle
                washing.{" "}
            ...
            <div className={styles.contentWrapper}>
              ...
              <div className={styles.content__text}>
                The Ultima, our specially designed Gantry/Rollover Design
                require a smaller footprint and are available with multiple
                options such as touchless, friction or a combination of both.
              </div>
            </div>
          </div>
          <div className={styles.body}>
            ...
            <div className={styles.contentWrapper}>
              ...
              <div className={styles.content__text}>
                ...
                kinds of vehicles from small trucks to complex shaped tractors
                and trailers.
              </div>
            </div>
            {/* 두 번째 */}
            <div className={styles.contentWrapper}>
              ...
              <div className={styles.content__text}>
                ...
                nozzle assemblies that have the best available cleaning power
                for tanker trucks, garbage trucks and other hard-to-clean odd
                shaped vehicles. For standard applications the Ultima can be
                equipped with conventional high-pressure nozzles.
              </div>
            </div>
            {/* 세 번째 */}
            <div className={styles.contentWrapper}>
              ...
              <div className={styles.content__text}>
                ...
                high-pressure washing features in this system play a major role
                in the cleaning processes. Additionally, the high-pressure water
                jets remove sand and other coarse particles, which could
                potentially scratch finishes of vehicles during the brush stage
                of the wash. The Ultima high pressure arch’s use both the
                conventional flat spray and advanced solid stream pattern for
                the maximum cleaning impact and efficient washing.
              </div>
            </div>
            {/* 네 번째 */}
            <div className={styles.contentWrapper}>
              ...
              <div className={styles.content__text}>
                Vertically sweeping side jets clean the sides from sills to
                roof. For enhanced cleaning, they oscillate up and down so that
                they overlap each other. Similarly, the high-pressure water jets
                on the rotary head oscillate sideways. High-pressure water jets,
                from nozzles situated in the rotary head, clean the vertical and
                ...
                the far-reaching water jets into vehicle recesses that are
                beyond the reach of brushes.
              </div>
            </div>
            {/* 다섯 번째 */}
            <div className={styles.contentWrapper}>
              <div className={styles.title__orange}>
                THESE SYSTEMS ARE AVAILABLE USING FRESH OR RECYCLED WATER AND
