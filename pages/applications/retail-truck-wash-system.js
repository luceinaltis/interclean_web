          ...
          <div className={styles.headInfo}>
            ...
            <div className={styles.contentWrapper}>
              ...
              <div className={styles.content__text}>
                ...
                <div style={{ height: "1rem" }} />
                {t("p4")}{" "}
                <span className={styles.content__link}>HF Acid Report</span>{" "}
                (PDF, 174.20 kB)
              </div>
            </div>
            {/* 두 번째 */}
...
RetailTruckWashSystems.getInitialProps = async () => ({
  namespacesRequired: [
    "applications__retail-truck-wash-system",
    "footer",
    "header",
  ],
});

export default withTranslation("applications__retail-truck-wash-system")(
  RetailTruckWashSystems
);
