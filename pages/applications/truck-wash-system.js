...
function TruckWashSystems({ t }) {
    ...
    const videoData = [
        ["kmlVLqWYCZQ", "/image/applications/truck/video1.png", "HD SALT TRUCK WASH SYSTEM"],
        ["hxD1ZRmBUMc", "/image/applications/truck/video2.png", "DRIVE THROUGH WASH SYSTEM"],
        [
            null, // 동영상 없음
        ...
        ["cbKFG-CZVDA", "/image/applications/truck/video5.png", "INTERCLEAN XR80 TIRE WASH SYSTEM"],
        [
            "vtQ7mBr3vy0",
            "/image/applications/truck/video6.png",
            "MULTIPLE VEHICLE WHEEL AND TIRE WASH SYSTEM",
        ],
        ["f88NESfx_TY", "/image/applications/truck/video7.png", "ROLLOVER TRUCK WASH"],
        [
            "YaNaQEPGdf8",
    ...
    const drawingsData = [
        ...
        ["/image/applications/truck/drawing/drawing2.jpg", "Truck Wash with Recycled Water", ""],
        ["/image/applications/truck/drawing/drawing3.jpg", "Truck Wash with Fresh Water", ""],
        ...
        ["/image/applications/truck/drawing/drawing7.jpg", "Commercial Truck Wash", ""],
        ["/image/applications/truck/drawing/drawing8.pdf", "Chassis Wash", ""],
        ["/image/applications/truck/drawing/drawing9.pdf", "XR 80 Wheel Wash", ""],
        ["/image/applications/truck/drawing/drawing10.pdf", "XR 120 Wheel Wash", ""],
        ["/image/applications/truck/drawing/drawing11.pdf", "Stryker Wheel Wash", ""],
    ];
...
export default withTranslation("applications__truck-wash-system")(TruckWashSystems);
