...
export default function MiningOilWashSystem() {
  ...
  const drawingsData = [
    ...
    [
      "/image/applications/mining/drawing/drawing3.pdf",
      "XR 120 Wheel Wash",
      "",
    ],
    [
      "/image/applications/mining/drawing/drawing4.pdf",
      "Stryker Wheel Wash",
      "",
    ],
  ];
        ...
        <div className="inner__container">
          <div className={styles.headInfo}>
            ...
            <div className={styles.content__text}>
              ...
              manually, especially if you don’t have the right tools for the
              job. Not only is manual washing huge labor cost, it can be
              dangerous to the health and safety of your employees and the
              environment. By implementing the correct design and equipment wash
              system package from InterClean, we can significantly reduce your
              vehicle downtime, promote a safe work environment, reduce water
              waste, and help decrease your ongoing maintenance costs. Call
          ...
          <div className={styles.body}>
            ...
            <div className={styles.body__content__wrapper}>
              ...
              <div className={styles.content__text}>
                The manual wash systems we provide rely on efficient and
                effective water recycling and include the proven EQ100 water
                recycling system. The low-pressure, high-volume design of our
                manual wash systems provide a stream of focused and intense
                water to maximize the cleaning impact and simplify cleaning the
                dirties vehicles.
              </div>
              ...
              <div className={styles.content__text}>
                ...
                <li>
                  Manual monitor and fire hose packages for standard
                  applications and detail work
                </li>
                <li>
                  High volume adjustable monitors with options for
                  semi-automatic joystick control packages
                </li>
                <li>
                ...
                <div className={styles.content__text__bold}>
                  The combined EQ100 water recycling system and high-pressure
            ...
            <div className={styles.body__content__wrapper}>
              ...
              <div className={styles.content__text}>
                ...
                industries, especially when it comes to cleaning large,
                heavy-duty vehicles. InterClean’s robotic wash systems provide a
                completely automatic wash system to clean oversized vehicles and
                gear by using multiple monitors that can perform multiple wash
                duties simultaneously. This means no more personnel in the bay.
                Our robotic wash systems for mining and oil equipment not only
                improve safety, they provide a better wash quality in less time.
              </div>
              <div className={styles.content__title__orange}>
            ...
            <div className={styles.body__content__wrapper}>
              <div
                className={`${styles.content__title__blue} ${styles.content__title__center}`}
              >
                INTERCLEAN’S HEAVY-DUTY TIRE, WHEEL AND UNDER-CHASSIS WASH
                SYSTEMS FEATURE THE ULTIMATE IN WATER RECYCLING TECHNOLOGY
              </div>
              <div className={styles.zoom__imageWrapper}>
                <img
              ...
              <div className={styles.content__text}>
                ...
                accommodate the types of mining and oil equipment you are
                cleaning and whether your operations will be manual, robotic, or
                a combination of both. Call +1 (734) 961-3300 to discuss your
                heavy duty wheel, chassis, and equipment wash system needs.
              </div>
            </div>
          </div>
        </div>
