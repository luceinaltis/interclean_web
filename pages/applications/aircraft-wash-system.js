        ...
        <div className="inner__container">
          <div className={styles__aircraft.headInfo}>
            ...
            <div className={styles__aircraft.content__text}>
              ...
              ensure a thorough clean, and a safe, efficient, operation wash
              after wash. Our touchless manual and automatic airplane wash
              systems are made in the USA and are installed and maintained by
              our local InterClean distributors. Contact us today for specs and
              pricing on a custom aircraft wash system.
            </div>
          </div>
          <div className={styles__aircraft.body}>
            ...
            <div className={styles__aircraft.body__content__wrapper}>
              ...
              <div className={styles__aircraft.content__text}>
                Our Clear Water Rinse System (CWRS) is a high volume, low
                pressure washing system in which approximately 80% of the water
                used during the rinse process is collected and recycled. To
                assure efficient rinsing, the water being recycled is
                continually monitored for salinity and other contaminants (Total
                Dissolved Solids). Once the TDS reaches a specified level the
                water is discharged to the sanitary sewer or water storage tank
                for disposal and fresh water is used to recharge the system.
                This system was designed specifically to meet the aircraft wash
                needs of the US Navy.
                <br />
                <br />
                ...
                water. If you are looking for a custom designed, US made
                airplane wash system that meets military specs, call +1 (734)
                961-3300 for a quote.
              </div>
            </div>
            {/* 두 번째 */}
            <div className={styles__aircraft.body__content__wrapper}>
              ...
              <div className={styles__aircraft.content__text}>
                ...
                replacement parts for an InterClean aircraft wash system,
                contact us today.
              </div>
            </div>
          </div>
